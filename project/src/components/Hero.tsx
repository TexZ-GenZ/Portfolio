...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 z-10 flex items-center justify-between">
        <motion.div 
          className="max-w-2xl"
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
        >
          <div className="w-80 h-80 rounded-full overflow-hidden border-4 border-purple-500/30">
            <img 
              src={myImage}
              alt="Priyanshu Samal" 
          ...
          <div className="absolute -bottom-10 -right-10 glow">
